...
@section('content')
    <center>
        <form class="form-login" method="post" action="{{ route('register.perform') }}">
           ...
           <!-- <img class="mb-4" src="{!! url('images/bootstrap-logo.svg') !!}" alt="" width="72" height="57"> -->
            ...
            <select class="form-select form-floating mb-3" aria-label="Default select example" name="user_type"
                id="user_type">
